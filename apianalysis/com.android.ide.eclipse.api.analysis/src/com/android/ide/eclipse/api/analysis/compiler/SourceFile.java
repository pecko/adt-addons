...
public class SourceFile implements ICompilationUnit {
    ...
    public boolean equals(Object o) {
        ...
        return this.sourceLocation == f.sourceLocation
                && this.resource.getFullPath().equals(f.resource.getFullPath());
    }
    ...
    String extractTypeName() {
        ...
        int sourceFolderSegmentCount = this.sourceLocation.sourceFolder.getFullPath()
                .segmentCount();
    ...
    public char[] getContents() {
        ...
        try {
            ...
            throw new AbortCompilation(true, new MissingSourceFileException(this.resource
    ...
    public char[] getFileName() {
        return this.resource.getFullPath().toString().toCharArray(); // do not
                                                                     // know
                                                                     // what you
                                                                     // want to
                                                                     // return
